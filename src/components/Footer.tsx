        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/menu" className="text-brown-200 hover:text-amber-300 transition-colors">Menu</Link></li>
              <li><Link href="/about" className="text-brown-200 hover:text-amber-300 transition-colors">About Us</Link></li>
              <li><Link href="/reservations" className="text-brown-200 hover:text-amber-300 transition-colors">Reservations</Link></li>
              <li><Link href="/contact" className="text-brown-200 hover:text-amber-300 transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-brown-200">123 Gourmet Street<br />Downtown, City 12345</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-brown-200">info@sonnas.com</span>
              </li>
            </ul>
          </div>
        </div>
