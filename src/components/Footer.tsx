...
export default function Footer() {
  return (
    <footer className="bg-brown-900 border-t border-brown-700">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-3xl font-display font-bold text-amber-300 mb-4">
              SONNAS
            </h3>
            <p className="text-brown-200 mb-6 max-w-md">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-brown-200 hover:text-amber-300 transition-colors">Home</Link></li>
              <li><Link href="/menu" className="text-brown-200 hover:text-amber-300 transition-colors">Full Menu</Link></li>
              <li><Link href="/about" className="text-brown-200 hover:text-amber-300 transition-colors">About Us</Link></li>
              <li><Link href="/reserve" className="text-brown-200 hover:text-amber-300 transition-colors">Reservations</Link></li>
              <li><Link href="/contact" className="text-amber-300 hover:text-amber-400 transition-colors font-medium">📞 Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-amber-300 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-brown-200">SONNAS Restaurant<br />123 Main Street, New Delhi</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+919876543210" className="text-green-300 hover:text-green-400 font-medium">+91 98765 43210</a>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 text-blue-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:orders@sonnas.com" className="text-blue-300 hover:text-blue-400">orders@sonnas.com</a>
              </li>
              <li className="flex items-center">
                <span className="text-green-400 mr-2 text-lg">💬</span>
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="text-green-300 hover:text-green-400 font-medium">WhatsApp Orders</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-brown-700 mt-8 pt-8 text-center">
          <p className="text-brown-400">
            ...
            <Link href="/privacy" className="hover:text-amber-300 ml-1">Privacy Policy</Link> | 
            <Link href="/terms" className="hover:text-amber-300 ml-1">Terms of Service</Link>
          </p>
        </div>
      </div>
    </footer>
